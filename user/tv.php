...
<head>
    ...
    <title><?php echo $shop_data["name"]; ?> | Tv-Series</title>
...
<body>
        ...
        <div class="row  text-white">
            ...
            <div class="col-12 m-0 p-0" style="min-height: 100vh;">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM `tv_series` ORDER BY RAND() LIMIT 10";
                    $rs = Database::search($query);
                    $num = $rs->num_rows;

                    ?>
                    <!-- carousel -->
                    <div id="myCarousel" data-aos="fade-in" class="carousel slide w-50" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner" style="width: 100%; height: 85vh;" id="imgs">
                            ...
                            for ($x = 0; $x < $num; $x++) {
                                ...
                                $table_find_query = "SELECT * FROM `tv_series` WHERE `tv_series`.`code`='" . $data["code"] . "'";
                                $table_find_rs = Database::search($table_find_query);
                                $table_find_num = $table_find_rs->num_rows;

                                if ($table_find_num > 0) { //then it is a tv
                            ...
                            ?>
                                    ...
                                    <div class="carousel-item" style="width: 100%; height: 85vh;">
                                        <img src="<?php echo $tv_series_data["link"]; ?>" style="width: 100%; height: 85vh; background-size: cover; object-fit: cover">
                                        <div class="container">
    ...
    <script src="../js/other/tv.js"></script>
</body>
