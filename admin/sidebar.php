...
?>
    ...
    <head>
        ...
        <title><?php echo $shop_data["name"]; ?> | Sidebar</title>
            ...
            <div class="row">
                ...
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 230px; height: 100vh;">
                    <a class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
                        <img src="<?php echo $shop_data["logo_link"]; ?>" style="width: 25%;" />
                        <span class="fs-4"><?php echo $shop_data["name"]; ?></span>
                    </a>
                    <hr>
                    <ul class="nav nav-pills flex-column mb-auto">
                        ...
                        <li>
                            <a href="home.php" class="nav-link link-dark" aria-current="page" id="homel">
                        ...
                        <li>
                            <a href="content.php" class="nav-link link-dark" id="content">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu text-small shadow">
                            <li style="cursor:pointer;"><a class="dropdown-item" onclick="logout();"><i class="bi bi-box-arrow-right me-2 fs-5"></i>Log out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
